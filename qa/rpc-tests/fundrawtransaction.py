...
class RawTransactionsTest(KazuSilverTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kazusilver address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kazusilver address" in e.error['message'])
