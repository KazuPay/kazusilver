...
class WalletTest (KazuSilverTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 KSLV from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 KSLV with subtract fee from amount
        ...
        # Sendmany 10 KSLV with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/kazusilver/kazusilver/issues/7463
        #     # '-salvagewallet',
        # ]
