...
unlocked to sign the KazuSilver-Qt.app bundle.
...
allowing somebody to distribute a KazuSilver-Qt.app or kazusilver-qt-setup.exe with a valid
...
that the kazusilver-qt.exe file inside the installer had not been tampered with.
