...
#define BOOST_TEST_MODULE KazuSilver Test Suite

#include "test_kazusilver.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kazusilver_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
