...
#ifndef KSLVCOIN_TEST_SCRIPTNUM10_H
#define KSLVCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KazuSilver Core 0.10.0, for cross-comparison.
 */
public:
