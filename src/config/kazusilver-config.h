/* src/config/kazusilver-config.h.  Generated from kazusilver-config.h.in by configure.  */
/* src/config/kazusilver-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KSLVCOIN_CONFIG_H

#define KSLVCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The KazuSilver Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "KazuSilver Core"
...
#define PACKAGE_BUGREPORT "https://github.com/kazucoin/kazusilver/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KazuSilver Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KazuSilver Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kazusilver"
