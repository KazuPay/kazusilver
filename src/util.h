 ...
 */
#ifndef KSLVCOIN_UTIL_H
#define KSLVCOIN_UTIL_H
...
extern const char * const KSLVCOIN_CONF_FILENAME;
extern const char * const KSLVCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("kazusilver-%s", name);
