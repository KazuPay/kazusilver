    ...
    mapper(0)
{
    ...
    ui->kazusilverAtStartup->setToolTip(ui->kazusilverAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kazusilverAtStartup->setText(ui->kazusilverAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->kazusilverAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKazuSilverConfButton_clicked()
{
