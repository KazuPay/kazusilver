...
#ifndef KSLVCOIN_QT_WALLETVIEW_H
#define KSLVCOIN_QT_WALLETVIEW_H
...
public:
    ...
    void setKazuSilverGUI(KazuSilverGUI *gui);
...
Q_SIGNALS:
    ...
    friend KazuSilverGUI;
};

#endif // KSLVCOIN_QT_WALLETVIEW_H
