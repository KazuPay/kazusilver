...
#ifndef KSLVCOIN_QT_KSLVCOINGUI_H
#define KSLVCOIN_QT_KSLVCOINGUI_H
...
/**
  KazuSilver GUI main class. This class represents the main window of the KazuSilver UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KazuSilverGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KazuSilverGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KazuSilverGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kazusilver wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // KSLVCOIN_QT_KSLVCOINGUI_H
