...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(KazuSilverUnits::KSLV),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = KazuSilverUnits::formatWithUnit(unit, amount, true, KazuSilverUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KazuSilverUnits::formatWithUnit(unit, balance, false, KazuSilverUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KazuSilverUnits::formatWithUnit(unit, unconfirmedBalance, false, KazuSilverUnits::separatorAlways));
    ui->labelStaking->setText(KazuSilverUnits::formatWithUnit(unit, stakingBalance, false, KazuSilverUnits::separatorAlways));
    ui->labelImmature->setText(KazuSilverUnits::formatWithUnit(unit, immatureBalance, false, KazuSilverUnits::separatorAlways));
    ui->labelTotal->setText(KazuSilverUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, KazuSilverUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KSLV")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(KazuSilverUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuSilverUnits::separatorAlways));
    ui->label7dStakingStats->setText(KazuSilverUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuSilverUnits::separatorAlways));
    ui->label30dStakingStats->setText(KazuSilverUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuSilverUnits::separatorAlways));
    ui->label1yStakingStats->setText(KazuSilverUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuSilverUnits::separatorAlways));
    ui->labelallStakingStats->setText(KazuSilverUnits::formatWithUnit(unit, aRange[i++].Total, false, KazuSilverUnits::separatorAlways));
}
