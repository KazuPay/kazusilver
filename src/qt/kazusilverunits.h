...
#ifndef KSLVCOIN_QT_KSLVCOINUNITS_H
#define KSLVCOIN_QT_KSLVCOINUNITS_H
...
/** KazuSilver unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KazuSilverUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KazuSilverUnits(QObject *parent);

    /** KazuSilver units.
      @note Source: https://en.kazusilver.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KSLV,
...
typedef KazuSilverUnits::Unit KazuSilverUnit;

#endif // KSLVCOIN_QT_KSLVCOINUNITS_H
