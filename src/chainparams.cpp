...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00002f5951af86d668369e0c2ca13ba2e3ecbab9eb00ee5a94e5ee49d8a2918e")), // Genesis
...
public:
    CDevNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("devnet.kazusilver.org", "devseed.kazusilver.org"));
