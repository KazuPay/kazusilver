...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKazuSilverAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKazuSilverAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKazuSilverAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKazuSilverAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKazuSilverAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKazuSilverAddress(arr[0].get_str()).Get() == demoAddress.Get());
