...
#ifndef KSLVCOIN_WALLET_KSLVTECH_H
#define KSLVCOIN_WALLET_KSLVTECH_H
...
#define KSLVTECH_DEFAULT_INPUT_DELAY 1
#define KSLVTECH_DEFAULT_OUT_DELAY 10
#define KSLVTECH_DEFAULT_ENTROPY 4
...
#endif //KSLVCOIN_WALLET_KSLVTECH_H
