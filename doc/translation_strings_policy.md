...
This document provides guidelines for internationalization of the KazuSilver Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kazusilver_en.ts` remains unchanged.
